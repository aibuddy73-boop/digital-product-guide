...
export function SiteHeader() {
  return <header className="border-b border-border bg-background"><div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4"><a href="#top" className="font-serif text-lg font-black tracking-tight text-foreground">HUSTLE TALK <span className="text-primary">WITH MARTIN</span></a><a href="#pricing" className="text-sm font-bold text-primary hover:underline">View launch offer</a></div></header>
}
