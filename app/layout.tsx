...
export const metadata: Metadata = {
  title: 'Stop Overthinking — The 7-Day Action System | Hustle Talk With Martin',
  description:
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: '/images/social-share.png', width: 1200, height: 630, alt: 'Stop Overthinking by Hustle Talk With Martin' }],
  },
  twitter: {
