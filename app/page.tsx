...
export default function Page(){return <div className="min-h-screen bg-background"><SiteHeader/><StickyNav/><main><Hero/><OpeningHook/><PromiseBanner/><FounderStory/><ProductReveal/><SystemTimeline/><WhatsInside/><WhoThisIsFor/><Testimonials/><Comparison/><Bonuses/><Pricing/><Guarantee/><FAQ/><Closing/></main><SiteFooter/><MobileCta/></div>}
